...
public enum NewsPropertyType implements PropertyType {
    ...
    CACHE_MAX_CAPACITY("news.cache.capacity.max"), NEWS_WEBSITE_TABLE("hbase.table.websites"),
    NEWS_WEBSITE_PAGES("hbase.table.pages"), HBASE_TEMPLATE_FAMILY("hbase.family.template"),
    HBASE_RSS_FAMILY("hbase.family.rss"), HBASE_TWITTER_FAMILY("hbase.family.twitter"),
    HBASE_VISITED_FAMILY("hbase.family.visited");
